...
import lu.uni.cityhunter.datastructure.ChallengeInfoWindowAdapter;
import lu.uni.cityhunter.datastructure.ErrorDialogFragment;
import lu.uni.cityhunter.datastructure.ListViewAdapter;
import lu.uni.cityhunter.datastructure.Mistery;
import lu.uni.cityhunter.datastructure.ReceiveTransitionsIntentService;
...
public class MisteryMapActivity extends FragmentActivity implements OnClickListener, ConnectionCallbacks, 
...
//	static final LatLng LUXEMBOURG = new LatLng(49.626597, 6.158986);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mistery_map);
